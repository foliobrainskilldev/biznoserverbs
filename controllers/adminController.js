...
exports.getAllUsers = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({ success: true, users: safeUsers, meta: { total, page, limit, totalPages: Math.ceil(total / limit) } });
...
exports.sendGlobalEmail = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({ success: true, message: `Mensagem enviada para ${users.length} utilizadores de forma segura.` });
